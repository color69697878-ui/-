...
async function handleEvent(event) {
  try {
    ...
    // 文字但內容是貼圖符號 / 純標點 / 純 emoji / 純 mention，也忽略
...
app.listen(PORT, () => {
  console.log(`🚀 BOT v4.7.4 RUNNING ON PORT ${PORT}`);
});
